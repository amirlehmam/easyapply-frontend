...
var xt = class {
  ...
  hsl() {
    ...
    return new xt(360 * (h3 ? 0 : n2 === a2 ? ((s2 - r2) / c2 + (s2 < r2 ? 6 : 0)) / 6 : n2 === s2 ? ((r2 - a2) / c2 + 2) / 6 : n2 === r2 ? ((a2 - s2) / c2 + 4) / 6 : 0), 100 * (h3 ? 0 : l2 > 0.5 ? c2 / (2 - n2 - o2) : c2 / (n2 + o2)), 100 * l2, "hsl");
  }
  ...
  rgb() {
    ...
    if ("lab" === (t2 = this.space) || "xyz" === t2 || "lch" === t2) {
      ...
      return new xt(255 * l2, 255 * h3, 255 * c2);
    }
    if ("hsl" === this.space) {
...
// dep:vue3-apexcharts
var vue3_apexcharts_default = m2;
export {
