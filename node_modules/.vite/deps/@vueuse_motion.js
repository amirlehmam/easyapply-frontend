...
function createDefu(merger) {
  return (...arguments_) => arguments_.reduce((p, c2) => _defu(p, c2, "", merger), {});
}
var defu = createDefu();
...
var supportsPointerEvents = () => {
  var _a2;
  return isBrowser && (window.onpointerdown === null || ((_a2 = import_meta.env) == null ? void 0 : _a2.TEST));
};
var supportsTouchEvents = () => {
  var _a2;
  return isBrowser && (window.ontouchstart === null || ((_a2 = import_meta.env) == null ? void 0 : _a2.TEST));
};
var supportsMouseEvents = () => {
  var _a2;
  return isBrowser && (window.onmousedown === null || ((_a2 = import_meta.env) == null ? void 0 : _a2.TEST));
};
      ...
      if (isTransitionKey(key) && typeof target[key] === "number") {
        for (const variantKey of ["enter", "visible", "visibleOnce"]) {
          ...
          if (variantConfig == null)
            continue;
          (_a2 = variantConfig.transition) != null ? _a2 : variantConfig.transition = {};
...
var CUSTOM_PRESETS = Symbol(
  ((_a = import_meta.env) == null ? void 0 : _a.MODE) === "development" ? "motionCustomPresets" : ""
);
...
function setupMotionComponent(props) {
  ...
  function applyTransitionHelpers(config, values) {
    ...
    for (const transitionKey of ["delay", "duration"]) {
      ...
      for (const variantKey of ["enter", "visible", "visibleOnce"]) {
        ...
        if (variantConfig == null)
          continue;
        (_a3 = variantConfig.transition) != null ? _a3 : variantConfig.transition = {};
  ...
  if (((_a2 = import_meta.env) == null ? void 0 : _a2.MODE) === "development") {
  ...
  function setNodeInstance(node, index, style) {
    var _a3, _b, _c;
    (_a3 = node.props) != null ? _a3 : node.props = {};
    (_c = (_b = node.props).style) != null ? _c : _b.style = {};
  ...
  install(app, options) {
    ...
    if (options && options.directives) {
      for (const key in options.directives) {
        ...
        if (!variants.initial && ((_a2 = import_meta.env) == null ? void 0 : _a2.MODE) === "development") {
          console.warn(
